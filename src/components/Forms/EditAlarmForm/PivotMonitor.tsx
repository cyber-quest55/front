...
import { updatePivotMonitorNotification } from '@/services/notification';
...
interface EditPivotMonitorAlarmFormProps {
...
const EditPivotMonitorAlarmForm = (props: EditPivotMonitorAlarmFormProps) => {
  const intl = useIntl();
