            ...
            onFinish={async (values: any) => {
              ...
              try {
                ...
                const newConfig = {
                  ...
                  kwh_peak: parseFloat(values.latest_irpd_config_v5?.kwh_peak ?? 1),
                  kwh_out_of_peak: parseFloat(values.latest_irpd_config_v5?.kwh_out_of_peak ?? 1),
                  kwh_reduced: parseFloat(values.latest_irpd_config_v5?.kwh_reduced ?? 1),
                };
