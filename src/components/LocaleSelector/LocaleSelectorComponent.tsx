...
const LocaleSelectorComponent: React.FC<SelectLangProps> = (props) => {
  const { globalIconClassName, postLocalesData, onItemClick, icon, style, reload } = props;
  ...
  return (
    <Dropdown menu={langMenu} placement={props.isCollapsed ? 'topRight' : 'bottomRight'}>
