...
const LocaleSelectorMobile: React.FC<SelectLangProps> = (props) => {
  const { globalIconClassName, postLocalesData, icon, style } = props;
  ...
  return (
    <>
      ...
      />
      <Space onClick={() => setIsVisible(true)} className={globalIconClassName} style={inlineStyle}>
        <i className="anticon" title={getLocale()}>
          {icon ? (
            icon
          ) : (
            <svg
...
export default LocaleSelectorMobile;
