declare namespace APIModels {
  ...
  type PivotReport = {
    ...
    data: {
      ...
      start_date: string
      end_date: string
      start_date_last_month: string
      end_date_last_month: string
      actions_count: {
        by_web: number
        by_panel: number
        not_executed: number
      ...
      unexpected_stops: {
        ...
        misalignment: number
        power_surge: number
        lack_of_pressure_last_month: number
        energy_blackot_last_month: number
        misalignment_last_month: number
        power_surge_last_month: number
      }
      hours_count: {
        total_hours: number
        ...
        wet_total_hours_last_month: number
        dry_total_hours_last_month: number
      }
      energy_consumption: {
        ponta: {
          hours: number
...
declare namespace WkModels {
  ...
  type PivotControllerStreamPanel = {
    id: number;
    current_angle: number;
    end_tower_pressure: number;
    content: {
  ...
  type PivotControllerStreamPeriodic = {
    id: number;
    current_angle: number;
    end_tower_pressure: number;
    content: {
      pluviometer_daily_measure: {
        daily_measure: number;
      };
      pluviometer_month_measure: {
        month_measure: number;
      };
      pluviometer_total: {
        total_measure: number;
      };
