...
export const GetCentralResponse: IResponse<API.GetCentralResponse> = Mock.mock({
  ...
  reseller: null,
  read_users: [
    1937, 2223, 686, 485, 1731, 128, 688, 726, 638, 574, 724, 974, 879, 897, 734, 1612, 1181, 1016,
    1144, 912, 1359, 211, 1253, 1301, 1146, 1622, 1654, 2039, 956, 777, 1017,
  ],
  write_users: [
    1937, 2223, 686, 576, 1731, 577, 128, 688, 726, 638, 574, 724, 974, 879, 897, 734, 1612, 1181,
    1016, 1144, 912, 1359, 211, 1253, 1301, 1146, 1622, 1654, 2039, 956, 777, 52, 1017, 78,
  ],
  sms_users: [],
  repeaters: [],
});
